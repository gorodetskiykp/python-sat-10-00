...
print('{:^55}{:^10}{:^15}{:^20}'.format('Наименование товара', 'Кол-во',
                                        'Цена', 'Сумма'))
print('{:<55}{:^10}{:^15}{:^20}'.format(goods[0], counts[0], prices[0],
                                        totals[0]))
print('{:<55}{:^10}{:^15}{:^20}'.format(goods[1], counts[1], prices[1],
                                        totals[1]))
print('{:<55}{:^10}{:^15}{:^20}'.format(goods[2], counts[2], prices[2],
                                        totals[2]))
